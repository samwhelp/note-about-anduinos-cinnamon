...
mod_cinnamon_config_for_keybind_custom () {
	...
	dconf write /org/cinnamon/desktop/keybindings/custom-keybindings/terminal/command "'kgx'"
	...
	dconf write /org/cinnamon/desktop/keybindings/custom-keybindings/text-editor/command "'gnome-text-editor'"
